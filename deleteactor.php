...
else
{
	...
	<h1> Section To Delete Actors</h1>
	<form  style=\" width:50%;height:100%;margin-left:30%; padding:10px;\" action=\"removeactor.php\" method=\"POST\"> ";
	...
	{
		echo"<label>Delete which actors</label>";
		?>
